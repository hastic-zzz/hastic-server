    ...
    def do_fit(self, dataframe: pd.DataFrame, segments: list) -> None:
        ...
        for segment in segments:
            if segment['labeled']:
                ...
                segment_cent_index, jump_height, jump_length = utils.find_parameters(segment_data, segment_from_index)
        ...
        for segment in segments:
            if segment['deleted']:
                ...
                if len(segment_data) == 0:
                    continue
                segment_cent_index = utils.find_parameters(segment_data, segment_from_index)[0]
